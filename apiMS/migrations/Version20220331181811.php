 ...
 */
final class Version20220331181811 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT DEFAULT \'["ROLE_USER]\' NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, firstname VARCHAR(150) DEFAULT NULL, lastname VARCHAR(150) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, status VARCHAR(255) DEFAULT \'Privé\' NOT NULL, signature_dish VARCHAR(255) DEFAULT NULL, bio VARCHAR(255) DEFAULT NULL, counter_like SMALLINT DEFAULT 0 NOT NULL, counter_follower INT DEFAULT 0 NOT NULL, counter_subscriber INT DEFAULT 0 NOT NULL, username VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, UNIQUE INDEX UNIQ_1483A5E9E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
